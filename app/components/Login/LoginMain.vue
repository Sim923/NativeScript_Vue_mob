<template>
  <StackLayout ref="mainContainer" class="main-container" :visibility="visible?'visible':'collapse'">
    <Label class="main-label" text="Welcome" :color="isLoggingIn? 'black' : 'white'"></Label>
    ...
    <!-- form controls 
        ...
        v-model="user.email"
    -->
    <GridLayout ref="formControls" class="form-controls" rows="auto, auto" translateY="0">
      <TextField
        hint="Email Address"
v-model="user.email"
        returnKeyType="next"
   ...
   console.log()
    ...
    login() {
      if (getConnectionType() === connectionType.none) {
        alert("We require an internet connection to log in.")
        return;
      }
    ...
    forgotPassword() {
      prompt({
        ...
        message: "Enter the email address to send a password reset request.",
        defaultText: "",
        okButtonText: "Ok",
